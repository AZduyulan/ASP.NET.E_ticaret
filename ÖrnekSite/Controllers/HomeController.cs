...
namespace ÖrnekSite.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            return PartialView(db.Products.Where(i => i.IsFeatured && i.IsApproved).Take(5).ToList());
        }
        ...
        {
            return PartialView(db.Products.Where(i => i.IsFeatured && i.Slider).Take(5).ToList());
        }
        // GET: Home
        public ActionResult Index()
        {
            return View(db.Products.Where(i=>i.IsHome).ToList());
        }
